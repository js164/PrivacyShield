...
export default function InitialQuestionCard({ question }) {
        ...
        <div className="p-6 bg-white rounded-2xl shadow-lg border border-slate-200">
            ...
            <div className="bg-white border border-slate-200 rounded-xl">
                <div className="p-4 flex items-start gap-4 cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
                    <div className="flex-shrink-0 h-8 w-8 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center font-bold"><CircleQuestionMark /></div>
                    <div className="flex-grow min-w-0">
                        <p className="font-semibold text-slate-800 break-words">{question.text}</p>
                    </div>
