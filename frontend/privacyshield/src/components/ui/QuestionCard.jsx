            ...
            <div className="bg-white border border-slate-200 rounded-xl transition-all duration-300">
                ...
                {isExpanded && (
                    <div className="pb-4 px-6 space-y-3">
                        {question.options.map((option, idx) => <NewOptionEditor key={option.id} option={option} optionIndex={idx} onUpdate={handleUpdateOption} onDelete={() => setOptionToDelete(option.id)} />)}
