        ...
        <>
            <div ref={ref} style={{ opacity }} className="mb-6 bg-white border border-gray-200 rounded-xl shadow-sm transition-all duration-300">
                <div className="p-4 flex items-center justify-between cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
                    ...
                    <span className={`text-xs sm:text-sm px-3 py-1 rounded-full capitalize ${question.multiChoice ? 'bg-purple-200 text-purple-800' : 'bg-green-200 text-green-800'}`}>{question.multiChoice ? "Multiple" : "Single"}</span>
