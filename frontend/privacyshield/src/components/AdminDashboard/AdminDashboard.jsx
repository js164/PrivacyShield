...
import { BarChart3, MessageCircleQuestionMark, Settings, Shield, Users } from 'lucide-react';
                    ...
                    <main className="p-6 bg-white rounded-2xl shadow-lg border border-slate-200">
                        ...
                        <div className="space-y-4">
                            {questions && questions.map((question, index) => (
                                <QuestionCard key={question._id} index={index} question={question} onDelete={handleDeleteQuestion} onUpdate={handleUpdateQuestion} />
                            ))}
